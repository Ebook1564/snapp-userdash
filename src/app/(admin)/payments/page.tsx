                                            ...
                                            <div className="space-y-6">
                                                ...
                                                <div className="space-y-4 pt-2 border-t border-gray-100 dark:border-gray-800">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <span className="text-sm font-bold text-gray-900 dark:text-white">{(item as Record<string, unknown>).grossTotal as string}</span>
                                                    </div>
                                                ...
                                                <div className="pt-4 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
                                                    ...
                                                    <span className="text-sm font-extrabold text-[#3e4cb4] dark:text-blue-400">{(item as Record<string, unknown>).grandTotal as string}</span>
                                                </div>
                                            </div>
                                        </div>
                                    )}
